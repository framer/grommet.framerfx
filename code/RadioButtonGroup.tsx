...
addPropertyControls(RadioButtonGroup, {
    ...
    border: {
        title: "Border",
        options: ["horizontal", "vertical", "all", "top", "left", "bottom", "right", undefined],
        optionTitles: ["Horizontal", "Vertical", "All", "Top", "Left", "Bottom", "Right", "None"],
        defaultValue: undefined,
        type: ControlType.Enum,
    },
    direction: {
        title: "Direction",
        options: ["row", "column", "row-responsive", "row-reverse", "column-reverse"],
        optionTitles: ["Row", "Column", "Row-responsive", "Row-reverse", "Column-reverse"],
        defaultValue: "row",
        type: ControlType.Enum,
    },
